...
public class NettySourceConnectorConfig extends AbstractConfig {
  ...
  public static final String HEALTHCHECK_CHANNEL_INIT_CLASS_CONFIG = "healthcheck.channel.init.class";
  public static final Class<? extends ChannelInitializer<Channel>> HEALTHCHECK_CHANNEL_INIT_CLASS_DEFAULT = DefaultHealthcheckChannelInitializer.class;
  ...
  public static final String TOPIC_DEFAULT = "netty_source";

  public static final String CHANNEL_CONFIG = "channel";
  public static final String CHANNEL_INITIALIZER_CLASS_CONFIG = CHANNEL_CONFIG + ".init.class";
  public static final String CHANNEL_INITIALIZER_HANDLERS_CONFIG = CHANNEL_CONFIG + ".handlers";
  ...
  protected static ConfigDef baseConfigDef() {
    ...
    configDef
        ...
        .define(CHANNEL_INITIALIZER_CLASS_CONFIG, Type.CLASS, null, Importance.HIGH,
            "Netty pipeline factory", group, ++order, Width.LONG, "Netty pipeline factory")
        .define(CHANNEL_INITIALIZER_HANDLERS_CONFIG, Type.LIST, Collections.emptyList(), Importance.LOW,
            "List of pipeline handlers", group, ++order, Width.LONG, "List of pipeline handlers. Used to override pipeline defaults")
        .define(TOPIC_CONFIG, Type.STRING, TOPIC_DEFAULT, Importance.HIGH, "Kafka topic", group, ++order, Width.LONG,
            "Kafka topic")
        ...
        .define(HEALTHCHECK_CHANNEL_INIT_CLASS_CONFIG, Type.CLASS, HEALTHCHECK_CHANNEL_INIT_CLASS_DEFAULT, Importance.MEDIUM, "Healthcheck channel init class", group, ++order, Width.LONG,
